...
class _ChargesScreenState extends State<ChargesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          title: const Text('Charges / Dépenses'),
            ...
            children: [
              Row(
                children: [
                  ...
                  _typeCard('simple', 'Dépense simple', Icons.receipt_rounded,
                      AppColors.info),
                ],
              ),
            ],
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          child: Column(
            children: [
              Icon(icon,
                  color: isSelected ? color : AppColors.textTertiary, size: 30),
...
class _MaintenanceFormState extends State<_MaintenanceForm> {
  ...
  String? _truck;
  final List<_MaintenanceLine> _lines = [_MaintenanceLine()];
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Column(
            children: [
              _totalRow('Sous-total pièces',
                  '${_subtotal.toStringAsFixed(0)} F', AppColors.textPrimary),
              const SizedBox(height: 10),
              AppMoneyField(
                  label: 'Main-d\'œuvre (optionnel)',
                  controller: _laborCtrl,
                  onChanged: (_) => setState(() {})),
              const SizedBox(height: 10),
              const Divider(),
              _totalRow('TOTAL GÉNÉRAL', '${_grandTotal.toStringAsFixed(0)} F',
                  AppColors.warning,
                  bold: true),
            ],
          ),
        ...
        AppSectionCard(
          ...
          children: [
            ...
            AppTextField(
                ...
                hint: 'Ex: Carburant, Péage...',
                controller: _typeCtrl,
                required: true,
                validator: (v) => v?.isEmpty == true ? 'Obligatoire' : null),
            const SizedBox(height: 14),
            AppMoneyField(
                label: 'Montant', controller: _amountCtrl, required: true),
            const SizedBox(height: 14),
