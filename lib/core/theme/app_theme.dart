...
// ─── Text Styles ──────────────────────────────────────────────────────────────
class AppTextStyles {
  static const _base = TextStyle(fontFamily: 'Roboto', color: AppColors.textPrimary);

  static final displayLarge  = _base.copyWith(fontSize: 28, fontWeight: FontWeight.w700);
  static final displayMedium = _base.copyWith(fontSize: 24, fontWeight: FontWeight.w700);
  ...
  static final bodyMedium    = _base.copyWith(fontSize: 13, fontWeight: FontWeight.w400, color: AppColors.textSecondary);
  static final bodySmall     = _base.copyWith(fontSize: 11, fontWeight: FontWeight.w400, color: AppColors.textTertiary);
  static final labelLarge    = _base.copyWith(fontSize: 14, fontWeight: FontWeight.w600, letterSpacing: 0.5);
  static final moneyMedium   = _base.copyWith(fontSize: 20, fontWeight: FontWeight.w700);
  static final moneySmall    = _base.copyWith(fontSize: 14, fontWeight: FontWeight.w700);
}
